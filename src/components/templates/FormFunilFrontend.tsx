    ...
    <div className="min-h-screen w-full flex flex-col items-center justify-center bg-[#112232] text-[#E1D8CF] font-sans relative overflow-hidden p-4">
      ...
      <div className="w-full max-w-2xl z-10 flex flex-col items-center">
        ...
        <div className="w-full relative min-h-[400px]">
          ...
          {/* Step 9: Estado */}
          {step === 9 && (
            <QCard icon={<MapPin className="text-[#A47428]" size={32} />} n={qNum} q="Em qual estado fica a sede da empresa?" sub="Selecione o estado.">
                ...
                {ESTADOS_BR.map((uf) => (
                  <button key={uf} onClick={() => { set("estado", uf); setTimeout(nextStep, 200); }}
                    className={cn(
                      ...
                      data.estado === uf ? "bg-[#A47428] border-[#A47428] text-white"
