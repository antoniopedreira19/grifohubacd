        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          <AnimatedSection className="max-w-3xl mx-auto text-center space-y-6">
            ...
            <div className="flex flex-wrap justify-center gap-4 pt-4">
               {["Resultados reais", "Acompanhamento personalizado"].map((item, i) => <div key={i} className="flex items-center gap-2 px-4 py-2 rounded-full bg-[#a37428]/20 border border-[#a37428]/30">
