    ...
    extend: {
      ...
      colors: {
        ...
        grifo: {
          ...
          "gold-hover": "hsl(var(--grifo-gold-hover))",
          surface: "hsl(var(--grifo-surface))",
          background: "hsl(var(--grifo-background))",
          "kanban-column": "hsl(var(--grifo-kanban-column))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
      ...
      boxShadow: {
        ...
        "soft-md": "0 4px 12px -2px rgba(0, 0, 0, 0.1), 0 8px 24px -4px rgba(0, 0, 0, 0.08)",
        "soft-lg": "0 8px 24px -4px rgba(0, 0, 0, 0.12), 0 16px 48px -8px rgba(0, 0, 0, 0.1)",
